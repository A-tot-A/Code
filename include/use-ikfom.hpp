...
// 定义的ieskf状态空间// 定义的ieskf状态空间，pos是位置，bg，ba是偏执 ,rot是iMU坐标系与世界坐标系的变换关系
...
//定义的协方差噪声格式
//角速度白噪声(3),加速度白噪声(3),角速度偏置(3),加速度偏置(3)
...
vect3 SO3ToEuler(const SO3 &orient) 
{
	...
	double unit = sqx + sqy + sqz + sqw; // if normalized is one, otherwise is correction factor//如果归一为1，否则为校正因子
